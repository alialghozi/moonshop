...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($stmt->num_rows > 0) {
            ...
            $role = 'buyer';
            $query = "INSERT INTO users (first_name, last_name, email, phone_number, address, password, role) VALUES (?, ?, ?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($query);
            $stmt->bind_param("sssssss", $first_name, $last_name, $email, $phone, $address, $password, $role);
...
<div class="container">
    ...
    <p>Registering as a seller? <a href="register-seller.php">Click here</a></p>
